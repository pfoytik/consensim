/**
 * This file contains declares the ConsensHelper class.
 */

#ifndef CONSENS_NODE_HELPER_H
#define CONSENS_NODE_HELPER_H
...
class ConsensHelper : public BitcoinNodeHelper
{
  public:
  /**
   * Create a PacketSinkHelper to make it easier to work with Consens applications
   *
   ...
   */
  ConsensHelper (std::string protocol, Address address, std::vector<Ipv4Address> peers, int noMiners,
