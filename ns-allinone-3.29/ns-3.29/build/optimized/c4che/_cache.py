...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-std=c++11', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
DEFINES = ['NS3_BUILD_PROFILE_OPTIMIZED', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_MPI=1', 'HAVE_IF_TUN_H=1']
DEFINES_MPI = ['NS3_OPENMPI', 'NS3_MPI']
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_PACKET_H': '', 'HAVE_GETENV': '', 'HAVE_SYS_STAT_H': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_RT': '', 'HAVE_SIGNAL_H': '', 'HAVE___UINT128_T': '', 'HAVE_IF_TUN_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': '', 'HAVE_STDLIB_H': '', 'HAVE_MPI': '', 'HAVE_PTHREAD_H': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['routing', 'udp', 'ipv6', 'realtime', 'socket', 'error-model', 'naming', 'energy', 'matrix-topology', 'udp-client-server', 'stats', 'traffic-control', 'wireless', 'tutorial', 'tcp']
...
NS3_EXECUTABLE_PATH = ['/home/pfoytik/Documents/Blockchain/simulation/ns-allinone-3.29/ns-3.29/build/optimized/src/fd-net-device', '/home/pfoytik/Documents/Blockchain/simulation/ns-allinone-3.29/ns-3.29/build/optimized/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/pfoytik/Documents/Blockchain/simulation/ns-allinone-3.29/ns-3.29/build/optimized/lib']
...
cfg_files = ['/home/pfoytik/Documents/Blockchain/simulation/ns-allinone-3.29/ns-3.29/build/optimized/ns3/config-store-config.h', '/home/pfoytik/Documents/Blockchain/simulation/ns-allinone-3.29/ns-3.29/build/optimized/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_MPI']
